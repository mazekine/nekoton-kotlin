...
/**
 * JSON-RPC transport implementation using native nekoton library.
 * 
 * This transport connects to JSON-RPC endpoints for blockchain communication.
 * 
 * @param endpoint The JSON-RPC endpoint URL
 */
class JrpcTransport(private val endpoint: String) : Transport {
    ...
    init {
        if (Native.isInitialized()) {
            nativeHandle = Native.createJrpcTransport(endpoint)
