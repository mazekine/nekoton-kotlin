...
/**
 * GraphQL transport implementation using native nekoton library.
 * 
 * This transport connects to GraphQL endpoints for blockchain communication.
 * 
 * @param endpoint The GraphQL endpoint URL
 */
class GqlTransport(private val endpoint: String) : Transport {
    ...
    init {
        if (Native.isInitialized()) {
            nativeHandle = Native.createGqlTransport(endpoint)
